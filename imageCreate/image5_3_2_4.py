"""
h = h + np.cos(x * np.abs(coslist[i]) ^ 0.5 + y * np.abs(sinlist[i]) ^ 0.5)
"""
...
def draw(q, s, w, xmin, ymin):
    ...
    name = '5_7_4 {} {}pi'.format(q, s)
    di.draw_image(q, s, w, color_index, name, xmin, ymin, mag, color_list, split_point, 33)
