"""
h = h + np.cos(x * np.log(np.abs(coslist[i])) + y * np.log(np.abs(sinlist[i])))
"""
...
def draw(q, s, w, xmin, ymin):
    ...
    name = '5_12_1 {} {}pi'.format(q, s)
    di.draw_image(q, s, w, color_index, name, xmin, ymin, mag, color_list, split_point, 52)
