"""
h = h + Tan(Sin(x * Cos(2 * pi * i / q) + y * Sin(2 * pi * i / q)) * Sin(y * Sin(2 * pi * i / q) +
x * Cos(2 * pi * i / q)) ^ 3) ^ 4
"""
...
def draw(q, s, w, xmin, ymin):
    ...
    name = '5_8_1_2 {} {}pi'.format(q, s)
    di.draw_image(q, s, w, color_index, name, xmin, ymin, mag, color_list, split_point, 92)
