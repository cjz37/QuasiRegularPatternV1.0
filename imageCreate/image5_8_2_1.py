"""
h = h + Exp(Cos(x * Cos(Cos(2 * pi * i / q)) + y * Sin(Sin(2 * pi * i / q))) ^ q)
"""
...
def draw(q, s, w, xmin, ymin):
    ...
    name = '5_8_2_1 {} {}pi'.format(q, s)
    di.draw_image(q, s, w, color_index, name, xmin, ymin, mag, color_list, split_point, 93)
